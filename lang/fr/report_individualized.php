...
$string['allstudentsreport'] = 'Rapport de tous les apprenants';
$string['allusers'] = 'Tous les apprenants';
$string['applyfilter'] = 'Appliquer';
$string['availablefrom'] = 'Date d\'ouverture';
$string['categorydepth'] = 'Profondeur du chemin de catégorie';
$string['categorydepth_desc'] = 'Nombre maximum de niveaux à afficher dans le chemin de catégorie. Mettre 0 pour afficher tous les niveaux.';
$string['closedate'] = 'Trace de fermeture';
$string['columnheader_connector'] = ' et';
$string['columnsettings'] = 'Paramètres d\'affichage du rapport individualisé';
...
$string['privacy:metadata'] = 'Le plugin de rapport individualisé apprenant ne stocke aucune donnée personnelle. Il affiche uniquement les logs et données de notes existants dans Moodle.';
$string['profestimated'] = 'Estimation enseignant';
...
$string['selectlearner'] = 'Taper ou sélectionner un apprenant';
...
$string['workshop_feedback_both'] = 'Les deux (soumission + évaluation par les pairs)';
...
$string['workshop_feedback_type_desc'] = 'Choisir quelles lignes afficher pour les activités Atelier. Les deux sont affichées par défaut.';

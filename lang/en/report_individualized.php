...
$string['allstudentsreport'] = 'All learners report';
$string['allusers'] = 'All learners';
...
$string['privacy:metadata'] = 'The Individualized learner report plugin does not store any personal data. It only displays existing Moodle logs and grade data.';
...
$string['selectlearner'] = 'Type or select a student';
